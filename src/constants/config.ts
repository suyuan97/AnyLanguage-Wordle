export const CONFIG = {
  ...
  language: 'Ktunaxa', // This changes the display name for your language
  wordLength: 5, // This sets how long each word is based on how many characters (as defined in orthography.ts) are in each word
  author: 'Suyuan Liu', // Put your name here so people know who made this Wordle!
  authorWebsite: 'https://linguistics.ubc.ca/profile/suyuan-liu/', // Put a link to your website or social media here
